...
export default defineConfig({
  lang: 'zh-CN',
  title: "HUHST CAS",
  description: "HUHST CAS Association",
  ...
  sitemap: {
    hostname: 'https://cas.wellwei.top/'
  },
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'OJ', link: 'http://10.6.19.12/JudgeOnline/' }
    ],

    footer: {
      message: 'HUHST CAS | HUHST ACM',
      copyright: 'Copyright © 2016-2024 HUHST CAS Association'
    },
